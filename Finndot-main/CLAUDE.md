# FinnDot Project Context

## Project Overview
FinnDot is a minimalist, AI-powered expense tracker for Android that automatically extracts transaction data from SMS messages using on-device processing.
...
## Package Structure
- Main app package: `com.anomapro.finndot`
- Parser core module: `com.finndot.parser.core` (unchanged - this is a separate module)
...
- **Edge-to-Edge**: All screens use FinnDot with default TopAppBar for consistent system bar handling
- **Consistent UI**: FinnDotScaffold provides default TopAppBar with options for title, navigation, actions, and transparency
...
Current version: 0.12 (versionCode: 12)

Recent version history:
- 0.12: Next release
- 0.11: Previous release
- 0.10: minSdk lowered to 28 (Android 9+ support)
...
1. **Location**: Add to `parser-core/src/main/kotlin/com/finndot/parser/core/bank/`
...
7. **Imports for parser-core**:
   - `com.finndot.parser.core.TransactionType`
   - `com.finndot.parser.core.ParsedTransaction`
   - `java.math.BigDecimal` for amounts

### Integration in main app:
- Use `com.anomapro.finndot.data.mapper.toEntity()` to convert ParsedTransaction to TransactionEntity
