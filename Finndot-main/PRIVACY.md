...
FinnDot AI is built with privacy as the core principle. We believe your financial data should remain yours alone.
...
- Data is only accessible to FinnDot AI app
...
## Optional Sign-In (Google Play variant only)

When you choose to sign in with Google (optional, you can skip):
- **Stored in cloud**: User ID, display name, email, profile photo URL, sign-up date, app version
- **Never stored**: SMS content, transaction data, bank details, or any financial information
- **Purpose**: Support, optional future sync features
- **Your control**: Skip sign-in to use the app fully without any cloud storage

**SMS and transaction data never leave your device**, regardless of sign-in choice.

## Third-Party Services

FinnDot AI does **NOT** use:
...
**Used only when you opt in**:
- Firebase Auth & Firestore (Google Play variant): Optional sign-in and profile storage only

**Note**: The Google Play Store variant includes Play Services for app updates and optional sign-in. The F-Droid variant has no Google services and no sign-in option.
...
FinnDot AI is fully open source:
- Review our code at [GitHub](https://github.com)
- Verify our privacy claims yourself
- Contribute to make it even better

## Children's Privacy

FinnDot AI is not directed at children under 13. We do not knowingly collect information from children.
...
- Open an issue on [GitHub](https://github.com issues)
...
*FinnDot AI - Privacy-first expense tracking with on-device AI*