# Contributing to FinnDot AI

Thank you for your interest in contributing to FinnDot AI! We welcome contributions from the community.

## How to Contribute

### 🐛 Reporting Bugs

1. Check if the bug has already been reported in [Issues](https://github.com issues)
...
1. Check [existing issues](https://github.com issues) for similar suggestions
...
1. Create a new parser class in `/app/src/main/java/com/finndot/tracker/data/parser/bank/`
...
```
app/
├── src/main/java/com/finndot/tracker/
│   ├── data/
...
- Follow development updates on [GitHub](https://github.com)
...
Thank you for helping make FinnDot AI better! 🚀
