...
private fun getCategory(merchantName: String): String {
    return com.anomapro.finndot.ui.icons.CategoryMapping.getCategory(merchantName)
}

private fun findDuplicateKeywords(): Set<String> {
    return com.anomapro.finndot.ui.icons.CategoryMapping.findDuplicateKeywords()
}