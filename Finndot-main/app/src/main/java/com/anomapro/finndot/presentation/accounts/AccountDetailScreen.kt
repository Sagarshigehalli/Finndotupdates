...
fun AccountDetailScreen(
    ...
    FinndotScaffold(
        ...
        LazyColumn(
            ...
            if (uiState.totalIncome > BigDecimal.ZERO || uiState.totalExpenses > BigDecimal.ZERO) {
                item {
                    MonthlyComparisonChart(
                        currentMonth = uiState.totalExpenses,
                        lastMonth = uiState.totalIncome,
                    ...
                    TransactionItem(
                        ...
                        onClick = {
                            navController.navigate(
                                com.anomapro.finndot.navigation.TransactionDetail(transaction.id)
                            )
                        }
                    )
                }
