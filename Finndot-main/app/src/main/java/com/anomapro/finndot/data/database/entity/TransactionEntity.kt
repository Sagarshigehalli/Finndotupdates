...
data class TransactionEntity(
    ...
    /**
     * Normalized merchant name for grouping and display.
     * If null, merchantName is used as the normalized name.
     * This allows multiple variations of the same merchant to be grouped together.
     */
    @ColumnInfo(name = "normalized_merchant_name")
    ...
    @ColumnInfo(name = "is_regret", defaultValue = "0")
