...
interface SubscriptionDao {
    ...
    @Query("SELECT * FROM subscriptions WHERE next_payment_date >= :startDate AND next_payment_date <= :endDate AND state = 'ACTIVE' ORDER BY next_payment_date ASC")
    fun getSubscriptionsDueInRange(startDate: LocalDate, endDate: LocalDate): Flow<List<SubscriptionEntity>>
