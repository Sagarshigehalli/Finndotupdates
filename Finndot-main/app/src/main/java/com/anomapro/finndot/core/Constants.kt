package com.anomapro.finndot.core
...
object Constants {
    ...
    object SmsProcessing {
        ...
        const val INITIAL_SCAN_MONTHS = 12
    ...
    object ModelDownload {
        ...
        const val MODEL_URL = "https://huggingface.co/litert-community/Qwen2.5-1.5B-Instruct/resolve/45f59957341f7e042a1f13a56de0272bec6fd4e9/Qwen2.5-1.5B-Instruct_multi-prefill-seq_q8_ekv4096.task"
        const val MODEL_FILE_NAME = "qwen2.5-1.5b-instruct.task"
        const val MODEL_SIZE_MB = 1600L // 1536 MB
    ...
    object Links {
        ...
        //const val WEB_PARSER_URL = "https://finndot-web-ywcyejojoa-el.a.run.app"
        const val WEB_PARSER_URL = "https://anomapro.com"
    }
}
