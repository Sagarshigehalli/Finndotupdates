package com.anomapro.finndot.presentation.add
...
import com.anomapro.finndot.domain.usecase.AddTransactionUseCase
import com.anomapro.finndot.domain.usecase.AddSubscriptionUseCase
import com.anomapro.finndot.domain.usecase.GetCategoriesUseCase
    ...
    fun saveTransaction(onSuccess: () -> Unit) {
        ...
        viewModelScope.launch {
            try {
                ...
                usageStatsService.recordEvent("add_transaction")
                onSuccess()
            } catch (e: Exception) {
                _transactionUiState.update { currentState ->
                    currentState.copy(
    ...
    fun saveSubscription(onSuccess: () -> Unit) {
        ...
        viewModelScope.launch {
            try {
                ...
                usageStatsService.recordEvent("add_subscription")
