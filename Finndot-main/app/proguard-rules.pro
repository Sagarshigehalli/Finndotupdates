...
-keep class com.anomapro.finndot.data.database.entity.** { *; }
-keep class com.anomapro.finndot.data.database.dao.** { *; }
...
-keep,includedescriptorclasses class com.anomapro.finndot.**$$serializer { *; }
-keepclassmembers class com.anomapro.finndot.** {
    *** Companion;
}
-keepclasseswithmembers class com.anomapro.finndot.** {
    kotlinx.serialization.KSerializer serializer(...);
}
...
# Keep data classes
-keep class com.anomapro.finndot.data.model.** { *; }
-keep class com.anomapro.finndot.domain.model.** { *; }
