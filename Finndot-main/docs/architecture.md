# FinnDot Architecture Guide

## Overview
FinnDot follows modern Android architecture guidelines with MVVM pattern, Clean Architecture principles, and Unidirectional Data Flow (UDF).
