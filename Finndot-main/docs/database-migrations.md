...
## Overview
This guide explains how to handle database migrations in FinnDot using Room's migration features.
...
@Database(
    ...
    autoMigrations = [
        AutoMigration(
            from = 1, 
            to = 2, 
            spec = FinndotDatabase.Migration1To2::class
        )
    ]
)

// Inside FinndotDatabase
@RenameColumn(
