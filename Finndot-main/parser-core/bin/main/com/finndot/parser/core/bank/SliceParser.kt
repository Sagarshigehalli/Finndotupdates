...
class SliceParser : BankParser() {
    ...
    override fun isTransactionMessage(message: String): Boolean {
        ...
        // Slice fixed deposits
        if (lowerMessage.contains("fixed deposit") && lowerMessage.contains("created")) {
            return true
        }
    ...
    override fun extractMerchant(message: String, sender: String): String? {
        ...
        return when {
            lowerMessage.contains("fixed deposit") && lowerMessage.contains("created") -> "Slice Fixed Deposit"
    ...
    override fun extractTransactionType(message: String): TransactionType? {
        ...
        return when {
            // Slice Fixed Deposit
            lowerMessage.contains("fixed deposit") && lowerMessage.contains("created") -> TransactionType.INVESTMENT
