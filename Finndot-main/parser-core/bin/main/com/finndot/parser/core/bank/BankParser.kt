...
abstract class BankParser {
     ...
     * Returns "Salary - COMPANY NAME" if detected, null otherwise.
     */
    protected open fun extractSalaryMerchant(message: String): String? {
        val lowerMessage = message.lowercase()
        
        // Salary check: NEFT + PRIVATE LIMITED + credited (or income context)
        if (message.contains("NEFT", ignoreCase = true) && 
            ...
            // Extract company name from NEFT string: NEFT/UTR/COMPANY NAME
