...
class HDFCBankParser : BankParser() {
    ...
    override fun isTransactionMessage(message: String): Boolean {
        ...
        // Skip HDFC Life insurance messages (policy payouts, premiums, etc.)
        if (lowerMessage.contains("hdfc life") || 
            lowerMessage.contains("po_hdfc life") ||
            lowerMessage.contains("policy no.") ||
            lowerMessage.contains("survival benefit")) {
            return false
        }
