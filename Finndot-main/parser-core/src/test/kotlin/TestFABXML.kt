...
import com.finndot.parser.core.test.SMSData
import com.finndot.parser.core.test.TestResult
import com.finndot.parser.core.test.XMLTestUtils
...
class FABXmlTest {
    ...
    private fun validateResult(
        result: com.finndot.parser.core.ParsedTransaction,
        smsData: SMSData
    ): List<String> {
